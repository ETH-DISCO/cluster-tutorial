...
#SBATCH --output=/itet-stor/{{USERNAME}}/net_scratch/demo/jobs/%j.out # redirection of stdout (%j is the job id)
#SBATCH --error=/itet-stor/{{USERNAME}}/net_scratch/demo/jobs/%j.err # redirection of stderr
#SBATCH --mem=100G
#SBATCH --nodes=1
