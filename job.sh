...
#SBATCH --output=/itet-stor/yjabary/net_scratch/cluster/jobs/%j.out # where to store the output (%j is the JOBID), subdirectory "log" must exist
#SBATCH --error=/itet-stor/yjabary/net_scratch/cluster/jobs/%j.err # where to store error messages
#SBATCH --mem=20G
#SBATCH --nodes=1
